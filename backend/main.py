...
def request_tindex():
    ...
    headers = {
        ...
        "User-Agent": "ShkarBoursePro2/3.1"
    }

    request_time = time.time()

    _daily_requests.append(request_time)
    ...
    try:
        ...
        if response.status_code == 429:
            _last_error = "TIndex درخواست را به دلیل Rate Limit رد کرد."
        ...
        if not isinstance(result, dict):
            _last_error = "پاسخ TIndex ساختار JSON معتبر ندارد."
